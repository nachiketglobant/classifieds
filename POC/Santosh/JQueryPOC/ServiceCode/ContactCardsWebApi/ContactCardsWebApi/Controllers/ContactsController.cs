    ...
    public class ContactsController : ApiController
    {
        ...
        public HttpResponseMessage Post(Customer value)
        {
            ...
            if (ModelState.IsValid)
            {
                try
                {
                    var Classified = repo.Save(value);
                    result = Request.CreateResponse<Customer>(HttpStatusCode.Created, Classified);
                    string newItemURL = Url.Link("DefaultApi", new { id = Classified._id });
        ...
        //
        public HttpResponseMessage Put(string id, Customer value)
        {
            HttpResponseMessage result = null;
